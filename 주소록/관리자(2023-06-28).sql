...
/*
addrDB 라는 이름의 저장소를 만들겠따
실제 데이터가 저장되는 공간은 c:/add/data/addr.dbf 파일이다
...
생성된 TABLESPACE 와 연결하는 사용자르 생성하고, 사용자(user)를 통하여
데이터에 접근한다
*/
-- 사용자 생성
...
세부적으로 부여해야 하는데, 학습하는 상황에서 세부적인 권한부여는 다소 불편함이 있어서
DBA 의 권한을 부여한다
